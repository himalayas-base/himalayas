...
class Plotter:
    ...
    def plot_cluster_bar(self, name: str, values: object, **kwargs) -> Plotter:
        ...
        Args:
            name (str): Track name.
            values (object): Cluster values as dict, Series, or DataFrame.
        ...
        Kwargs:
            ...
            cluster_col (str): Cluster id column for DataFrame input. Defaults to "cluster".
            pval_col (str): Value column for DataFrame input. Defaults to "pval".

        Returns:
            Plotter: Self for chaining.

        Raises:
            TypeError: If values is not a dict, Series, or DataFrame.

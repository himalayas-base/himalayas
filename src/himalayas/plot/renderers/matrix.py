...
def _draw_matrix(
    *,
    ...
    outer_lw: float,
    outer_color: str,
    boundary_registry: Optional[BoundaryRegistry],
) -> None:
    """
    ...
    Args:
        ...
        norm (Optional[Normalize]): Normalization object.
        ...
        boundary_registry (Optional[BoundaryRegistry]): Boundary registry for overlays.
    """
